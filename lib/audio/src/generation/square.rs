...
pub struct SquareWave<S: Sample, const CHANNELS: usize> {
    step: Ratio<u32>,
    phase: Ratio<u32>,
    amplitude: S,
}

impl<S: Sample, const CHANNELS: usize> SquareWave<S, CHANNELS> {
...
impl<S: Sample, const CHANNELS: usize> Iterator for SquareWave<S, CHANNELS> {
