...
pub struct VulkanState {
    ...
    pub render_image: <Vulkan as GraphicsApi>::ComponentFramebuffer,
}

impl Chip8DisplayBackend<Vulkan> for VulkanState {
    ...
    fn get_framebuffer(&mut self) -> &<Vulkan as GraphicsApi>::ComponentFramebuffer {
        &self.render_image
    }
}
