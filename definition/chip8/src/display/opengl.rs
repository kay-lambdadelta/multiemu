...
struct OpenGlState {
    ...
    pub render_image: Rc<RefCell<Texture2d>>,
}
...
impl Chip8DisplayBackend for OpenGlState {
    ...
    fn commit_display(&self) {
        ...
        self.render_image.borrow_mut().write(
            glium::Rect {
                left: 0,
                bottom: 0,
                width: 64,
...
pub fn set_display_data(
    ...
    initialization_data: Rc<<OpenGlRendering as RenderBackend>::ComponentInitializationData>,
) -> Rc<RefCell<<OpenGlRendering as RenderBackend>::ComponentFramebuffer>> {
    ...
    let render_image = Rc::new(RefCell::new(
        Texture2d::new(
            &initialization_data.context,
            RawImage2d {
